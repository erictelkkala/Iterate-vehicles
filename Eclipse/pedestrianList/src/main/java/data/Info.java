...
public class Info {
	...
	/**
	 * @param pedestrians the pedestrians to set
	 */
	public void setPedestrians(int pedestrians) {
		this.pedestrians = pedestrians;
	}
	public void setPedestrians(String s) {
		try {
			this.pedestrians = Integer.parseInt(s);
		}
	...
	public void setCyclist(String s) {
		try {
			this.cyclist = Integer.parseInt(s);
		}
		catch(NumberFormatException e) {
			cyclist=-1;
		}
	...
	public void setScooters(String s) {
		try {
			this.scooters = Integer.parseInt(s);
		}
		catch(NumberFormatException e) {
			scooters=-1;
		}
